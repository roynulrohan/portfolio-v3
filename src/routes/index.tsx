    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-base-300 via-base-200 to-base-300 relative overflow-hidden'>
            ...
            <div className='absolute inset-0 overflow-hidden'>
                ...
                <div className='absolute top-[20%] right-[10%] w-24 h-24 border-2 border-teal-400/30 rounded-lg rotate-12 floating'></div>
                <div className='absolute bottom-[20%] left-[10%] w-32 h-32 border-2 border-teal-400/30 rounded-full floating-reverse'></div>
            ...
            <section id='main' className='relative flex flex-col justify-center items-start p-5 min-h-screen'>
                <div className='p-3 flex flex-col space-y-2 w-full max-w-5xl mx-auto md:ml-[15%] backdrop-blur-sm'>
                    <div className='text-left space-y-8'>
                        <span className='flex text-lg tracking-[0.3em] text-teal-400 font-medium fade-in-up'>{getAnimatedRoleMessage}</span>

                        <div className='space-y-4'>
                            <h1 className='flex md:text-8xl sm:text-7xl text-5xl text-white font-bold tracking-tight leading-[1.1] max-w-4xl fade-in-up delay-200'>
                                {getAnimatedTitle}
                            </h1>
                            <p className='flex md:text-4xl sm:text-3xl text-2xl text-teal-400/90 font-medium tracking-tight leading-relaxed fade-in-up delay-400'>
                                {getAnimatedTagline}
                            </p>
                        </div>
                        ...
                        {/* Social Links */}
                        <div className='flex gap-6 mt-12 items-center fade-in-up delay-600'>
                            <a
                                title='GitHub'
