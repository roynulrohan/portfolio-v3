        ...
        <div className='space-y-8'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col gap-6 animate-fadeIn'>
                    {/* Contact Links */}
                    <div className='flex-1 p-6 rounded-xl bg-base-300/50 border border-teal-400/20 hover:border-teal-400/40 transition-all'>
                ...
                {/* Contact Form */}
                <div className='flex-1 p-6 rounded-xl bg-base-300/50 border border-teal-400/20 hover:border-teal-400/40 transition-all animate-fadeIn'>
                    <h3 className='text-xl font-semibold text-white flex items-center gap-2 mb-6'>
                    ...
                    <form action={`https://formspree.io/f/${import.meta.env.VITE_FORMSPREE_FORM_ID}`} method='POST' className='space-y-6'>
                        <div className='space-y-2'>
                            <label htmlFor='email' className='block text-white/80 font-medium'>
                                Email
                            </label>
                            <input
                                type='email'
                        ...
                        <div className='space-y-2'>
                            <label htmlFor='message' className='block text-white/80 font-medium'>
                                Message
                            </label>
                            <textarea
                                id='message'
