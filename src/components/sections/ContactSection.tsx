        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <form className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full px-6 py-3 bg-teal-400 hover:bg-teal-500 text-black/80 hover:text-black font-medium rounded-lg transition-all duration-300"
                    >
                        Send Message
                    </button>
                </form>
