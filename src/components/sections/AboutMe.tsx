                ...
                <div className="prose prose-invert prose-teal max-w-none">
                    <div className="relative space-y-8 before:absolute before:inset-0 before:ml-[23px] before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-teal-400/50 before:to-transparent">
                        <div className="relative flex items-start gap-6">
                            <div className="flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-base-300/70 border border-teal-400/30 shrink-0">
                                <span className="text-2xl sm:text-4xl">👶</span>
                            </div>
                            <div className="flex-1 bg-base-300/30 rounded-lg p-4 border border-teal-400/20">
                                <h3 className="text-white/90 text-base sm:text-lg font-semibold mb-2 flex items-center gap-2">
                                    The Early Days
                                    <span className="text-xs sm:text-sm text-teal-400/70">2010-2016</span>
                                </h3>
                        ...
                        <div className="relative flex items-start gap-6">
                            ...
                            <div className="flex-1 bg-base-300/30 rounded-lg p-4 border border-teal-400/20">
                                <h3 className="text-white/90 text-base sm:text-lg font-semibold mb-2 flex items-center gap-2">
                                    ...
                                    <span className="text-xs sm:text-sm text-teal-400/70">2016-2020</span>
                                </h3>
                                <p className="text-sm sm:text-lg text-white/80 leading-relaxed">
                                ...
                                <p className="text-sm sm:text-lg text-white/80 leading-relaxed mt-4">
                        ...
                        <div className="relative flex items-start gap-6">
                            ...
                            <div className="flex-1 bg-base-300/30 rounded-lg p-4 border border-teal-400/20">
                                <h3 className="text-white/90 text-base sm:text-lg font-semibold mb-2 flex items-center gap-2">
                                    Professional Career
                                    <span className="text-xs sm:text-sm text-teal-400/70">2020-Present</span>
                                </h3>
                                <p className="text-sm sm:text-lg text-white/80 leading-relaxed">
